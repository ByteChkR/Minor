...
namespace GameEngine.components
{
    public class MeshColliderComponent : AbstractComponent, IColliderComponent
    {
        ...
        protected override void Awake()
        {
            ...
            {
                vertexList.AddRange(model.Meshes[i].ToSequentialVertexList());
            }
            ...
            {
                triBuf[vert] = new Triangle(new System.Numerics.Vector3(vertexList[vert].X, vertexList[vert].Y, vertexList[vert].Z),
                    new System.Numerics.Vector3(vertexList[vert + 1].X, vertexList[vert + 1].Y, vertexList[vert + 1].Z),
                    new System.Numerics.Vector3(vertexList[vert + 2].X, vertexList[vert + 2].Y, vertexList[vert + 2].Z));
            }
