...
namespace GameEngine.engine.rendering
{
    public class Renderer
    {
        ...
        public void Render(World world, GameObject obj, Camera cam, bool recursive)
        {
            Render(world, obj, obj.GetWorldTransform(), Matrix4.Invert(cam.GetWorldTransform()), cam.Projection, recursive);
        }

        public void Render(World world, GameObject obj, Matrix4 modelMat, Matrix4 viewMat, Matrix4 projMat,
            bool recursive)
        {
        ...
        public void RenderSelf(World world, GameObject obj, Matrix4 modelMat, Matrix4 viewMat, Matrix4 projMat)
        {
            Render(world, obj.shader, obj.model, modelMat, viewMat, projMat);
        }


        public void RenderChildren(World world, GameObject obj, Matrix4 modelMat, Matrix4 viewMat, Matrix4 projMat,
            bool recursive)
        {
        ...
        public void Render(World world, ShaderProgram prog, GameModel model, Matrix4 modelMat, Matrix4 viewMat, Matrix4 projMat)
        {
