...
//{
//    public class GameModel1 : IDestroyable
//    {
...
//        public GameModel1(string file, bool deallocOnDestroy)
//        {
...
//                GameTexture tx = ResourceManager.TextureIO.FileToTexture(directory + s.FilePath);
//                tx.TexType = texType;
//                tx.Path = s.FilePath;
//                ret.Add(tx);
//            }
