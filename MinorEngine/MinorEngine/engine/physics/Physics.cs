...
namespace GameEngine.engine.physics
{
    ...
    public static class Physics
    {
        ...
        public static BodyProperty<Layer> CollisionFilters;
        ...
        public static void Init()
        {
            ...
            simulation = Simulation.Create(bufferPool, new NarrowPhase(), new PoseIntegrator(new Vector3(0, -10, 0)));
        ...
        internal static BodyReference AddBoxDynamic(float mass, Vector3 position, Vector3 dimensions, ColliderComponent comp)
        {
            ...
            int handle = simulation.Bodies.Add(
        ...
        {
            int i = simulation.Statics.Add(new StaticDescription(position,
                new CollidableDescription(simulation.Shapes.Add(new Box(dimensions.X, dimensions.Y, dimensions.Z)),
                    0.1f)));
        }
        ...
        {
            int i  = simulation.Statics.Add(new StaticDescription(position, new CollidableDescription(simulation.Shapes.Add(new Sphere(radius)), 0.1f)));
